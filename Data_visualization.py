...
def plot_by_age(df):
    ...
    data = {'2017': df.loc[idx, ['2017.1', '2017.2', '2017.3', '2017.4', '2017.5', '2017.6', '2017.7', '2017.8', '2017.9', '2017.10']].values.tolist()[0],
    ...
    chart_data = pd.DataFrame.from_dict(data=data, orient='index',
